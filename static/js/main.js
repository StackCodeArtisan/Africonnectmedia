// Main JavaScript for AFRI-CONNECT MEDIA
...
function initAnimations() {
    ...
    const animateElements = document.querySelectorAll('.card, .work-item, .service-icon, .team-avatar');
